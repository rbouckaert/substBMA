package substbma.evolution.branchratemodel;
...
public class SynchronizableUCRelaxedClock extends BranchRateModel.Base {
    ...
    public void initAndValidate() {
        ...
        //System.out.println("categories: "+categories+" "+categories.getLower()+" "+categories.getUpper());
